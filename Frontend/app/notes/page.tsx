...
//       return <Pronote onAddNote={handleAddNote} />;
//     } else if (renderFile === "Zen") {
//       return <Zen  />;
//     } else {
//       return <Notesdisplay list={notes}/>;
//     }
//   };
...
//         </div>
//         {/* main */}
//         <div className="flex-1 bg-black">{renderComponent()}</div>
//       </div>
//     </div>
//   );
// }
  ...
  return (
    <div>
      ...
      <div className="absolute top-9 left-9">
        <Image
          className="animate-pop-out cursor-pointer"
          onClick={clickHandler}
          src="/assets/navbar/hamburger.svg"
          width={25}
          height={25}
